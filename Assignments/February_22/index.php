  ...
  <body>
    <fieldset>
      ...
      <form action="endpoint.php">
        <div class="form group"><label for="payment amount">Payment Amount</label> <input type="text" name="payment amount" value="" id="payment amount" placeholder="Payment Amount"></div>
